...
namespace Core.Aspects.Validation
{
    public class ValidationAspect : MethodInterception
    {
        ...
        {
            var validator = (IValidator)Activator.CreateInstance(_validatorType); //this is the use of Reflection, example on run time, creating an instance, a validator class.
